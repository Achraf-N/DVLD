    ...
    public partial class ctrScheduleTest : UserControl
    {
        ...
        public void LoadInfo(int LocalDrivingLicenseApplicationID, int AppointmentID = -1)
        {
            ...
            if (_Mode == enMode.AddNew)
            {
                ...
                if (_CreationMode == enCreationMode.RetakeTestSchedule)
                {
                    _TestAppointment = clsTestAppointment.GetLastTestAppointment(_LocalDrivingLicenseApplication.LocalDrivingLicenseApplicationID,_TestTypeID);
                    if(_TestAppointment != null && _TestAppointment.AppointmentDate>DateTime.Now)
                    dtpTestDate.MinDate = _TestAppointment.AppointmentDate;
                    else dtpTestDate.MinDate = DateTime.Now;
